...
//     experiments/ff1_w4a4_swiglu_topk_reduce_mech.cu -o /tmp/ff1_w4a4_mech
//
...
void ff1_w4a4_swiglu_topk_reduce_mech(
...
int main(int argc, char** argv) {
    ...
    CUDA_CHECK(cudaOccupancyMaxActiveBlocksPerMultiprocessor(
        &blocks_per_sm, ff1_w4a4_swiglu_topk_reduce_mech, CTA, smem_bytes));
    ...
    std::fprintf(f,
        "%s,%d,no_workspace_n16x2_pf32_tma_mech,balanced_exact_live_scattered,"
