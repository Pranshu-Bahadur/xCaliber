...
//     experiments/ff1_w4a4_swiglu_topk_reduce_mech_actreg.cu -o /tmp/ff1_w4a4_actreg
//
...
void ff1_w4a4_swiglu_topk_reduce_mech_actreg(
...
int main(int argc, char** argv) {
    ...
    CUDA_CHECK(cudaOccupancyMaxActiveBlocksPerMultiprocessor(
        &blocks_per_sm, ff1_w4a4_swiglu_topk_reduce_mech_actreg, CTA, smem_bytes));
    ...
    std::fprintf(f,
        "%s,%d,no_workspace_n16x2_pf32_actreg_ca_scalar,balanced_exact_live_scattered,"
