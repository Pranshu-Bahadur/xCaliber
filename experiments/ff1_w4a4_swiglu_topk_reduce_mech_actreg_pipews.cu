...
//     experiments/ff1_w4a4_swiglu_topk_reduce_mech_actreg_pipews.cu -o /tmp/ff1_w4a4_actreg_pipews
//
...
void ff1_w4a4_swiglu_topk_reduce_mech_actreg_pipews(
...
#endif
    uint32_t scaleA, scaleA1, scaleB0, scaleB1;
#if ACTREG
...
int main(int argc, char** argv) {
    ...
    CUDA_CHECK(cudaFuncSetAttribute(
        ff1_w4a4_swiglu_topk_reduce_mech_actreg_pipews,
        cudaFuncAttributeMaxDynamicSharedMemorySize,
        smem_bytes));

    __nv_bfloat16 XGSINV = __float2bfloat16(0.5f);
    CUDA_CHECK(cudaMemset(dX, 0, hX.size() * sizeof(__nv_bfloat16)));
    ff1_w4a4_swiglu_topk_reduce_mech_actreg_pipews<<<E, CTA, smem_bytes>>>(
    ...
    CUDA_CHECK(cudaOccupancyMaxActiveBlocksPerMultiprocessor(
        &blocks_per_sm, ff1_w4a4_swiglu_topk_reduce_mech_actreg_pipews, CTA, smem_bytes));
    ...
    std::fprintf(f,
        "%s,%d,no_workspace_n16x2_pf32_actreg_ca_pipe_bw,balanced_exact_live_scattered,"
