...
//     experiments/ff1_w4a4_zerowire.cu -o /tmp/ff1_w4a4_zerowire
//
...
int main(int argc, char** argv) {
    ...
    ff1_w4a4_zerowire<<<E, CTA, smem_bytes>>>(
    ...
    CUDA_CHECK(cudaOccupancyMaxActiveBlocksPerMultiprocessor(
        &blocks_per_sm, ff1_w4a4_zerowire, CTA, smem_bytes));
    ...
    std::fprintf(f,
        "%s,%d,zerowire,balanced_exact_live_scattered,"
