// x57: SM120a W4A4 FF1 -> SwiGLU -> topk_W -> BF16 bulk-reduce.
...
/*
    ...
    X[I,NP] BF16
      zero before launch; topk-weighted SwiGLU reduces directly into X
*/
