// xR57F1_contiguous_graph: expert-contiguous NVFP4 FF1 -> paired NVFP4 Y.
...
/*
    ...
    routed N16 pairing
      ...
      load one W13/S13 packet -> up to four N8 MMAs
    ...
    post13  = BF16x2(W13GS[0/1] * XGSINV2)
